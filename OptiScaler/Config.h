...
class Config
{
  public:
    ...
    CustomOptional<bool> FsrRrNrcEnabled { false }; // Neural Radiance Cache for far-field irradiance stabilization (experimental)
    ...
    CustomOptional<float> FsrRrLinearDepthBoundsMin { 0.0f }; // sample default
    CustomOptional<float> FsrRrLinearDepthBoundsMax { 1024.0f }; // sample default; coarser max = blocky VCP
